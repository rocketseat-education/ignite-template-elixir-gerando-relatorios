defmodule GenReportTest do
  ...
  describe "build/1" do
    ...
    test "Whent passing parameters, returns an error" do
  ...
  describe "build_from_many/1" do
    test "When recive a list, return a report" do
    ...
    test "Whent passing parameters, returns an error" do
      ...
      assert response == {:error, "Insira o nome do arquivo dentro de uma lista"}
    end

    test "Whent passing a list of filenames, returns an error" do
      response = GenReport.build_from_many()

      assert response == {:error, "Insira o nome do arquivo"}
    end
  end
end
